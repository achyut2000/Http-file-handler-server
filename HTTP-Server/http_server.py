...
class HTTPRequestHandler(BaseHTTPRequestHandler):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fih = HTTPRequestHandler.FIH
        self.hs = HTTPRequestHandler.HS
    ...
    def do_POST(self):
        ...
        def parse_post_data():
            if self.path == "/delete":
                ...
                fullname = os.path.join(HTTPRequestHandler.CWD, filename)
                try:
                    os.remove(fullname)
    ...
    def real_path(self, path):
        return os.path.relpath(path, HTTPRequestHandler.CWD)
...
def main():
    ...
    server_address = ('', port)
    server = MultiThreadingServer(server_address, HTTPRequestHandler)
